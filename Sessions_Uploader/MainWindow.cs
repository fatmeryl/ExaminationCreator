...
namespace Sessions_Uploader
{
    public partial class MainWindow : Form
    {
        ...
        private TimeSpan CalculateExaminationDurationRoundedToHours(IEnumerable<string> files)
        {
        ...
        private TimeSpan SetAutomatedCalculatedInterval(IEnumerable<string> files)
        {
